...
from openpype.lib import Anatomy, get_linked_assets
...
class AbstractTemplateLoader:
    ...
    def __init__(self, placeholder_class):
        ...
        self.current_asset = io.Session["AVALON_ASSET"]
        self.project_name = io.Session["AVALON_PROJECT"]
        self.host_name = io.Session["AVALON_APP"]
        self.task_name = io.Session["AVALON_TASK"]
        self.placeholder_class = placeholder_class
        self.current_asset_docs = io.find_one({
            "type": "asset",
    ...
    def get_placeholder_representations(
        ...
        for db_filter in placeholder_db_filters:
            placeholder_representations = list(io.find(db_filter))
