...
class PressHoverBtn(QtWidgets.QPushButton):
    ...
    def mousePressEvent(self, event):
        ...
        super(PressHoverBtn, self).mousePressEvent(event)

    def mouseReleaseEvent(self, event):
        self._mouse_pressed = False
        self._mouse_hovered = False
        self.change_state.emit(self._mouse_hovered)
        super(PressHoverBtn, self).mouseReleaseEvent(event)
    ...
    def mouseMoveEvent(self, event):
        ...
        super(PressHoverBtn, self).mouseMoveEvent(event)
