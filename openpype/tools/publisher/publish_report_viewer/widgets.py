...
class PublishReportViewerWidget(QtWidgets.QFrame):
    def __init__(self, parent=None):
        ...
        QtCore.QObject.connect(instances_view.selectionModel(),
                               QtCore.SIGNAL('currentChanged(QModelIndex, QModelIndex)'), self._on_instance_change)
        ...
        QtCore.QObject.connect(plugins_view.selectionModel(),
                               QtCore.SIGNAL('currentChanged(QModelIndex, QModelIndex)'), self._on_plugin_change)
