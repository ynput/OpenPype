...
def main(input_path="",
    ...
    output_path = os.path.join(
        output_path, name + preset_templates[preset]["output_extension"]
    ).replace("//", "/")
    ...
    ffmpeg_args = [lib.get_ffmpeg_tool_path("ffmpeg"), "-y"]
