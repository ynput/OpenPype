...
from openpype_modules.ftrack.lib import ServerAction, statics_icon


class CreateProjectFolders(ServerAction):
    ...
    """
    label = "Hornet - Create FTrack Structure"
    identifier = "create.project.structure.server"
