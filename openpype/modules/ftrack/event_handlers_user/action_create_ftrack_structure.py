...
class CreateProjectFoldersOnFtrack(BaseAction):
    """Action create hierarchy only in Ftrack.

    Based on the Create Project Structure action.
    Creation hierarchy in Ftrack is based on presets.
    These presets are located in:
        `Project Settings > Global > Project Folder Structure`
    ...
    identifier = "create.ftrack.structure"
    label = "Create Ftrack Project Structure"
    description = "Creates folder structure only on ftrack"
...
def register(session):
    CreateProjectFoldersOnFtrack(session).register()
