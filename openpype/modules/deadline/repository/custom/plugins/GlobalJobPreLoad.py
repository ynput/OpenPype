...
def inject_openpype_environment(deadlinePlugin):
    ...
    try:
        ...
        if requested_version:
            ...
            print(DirectoryUtils.SearchDirectoryList("/Applications/OpenPype 3.15.0.app"))
            print("dir_list::{}".format(dir_list))
            print("instll_dir::{}".format(install_dir))
            if install_dir:
                ...
                print("sub_dirs::{}".format(sub_dirs))
        ...
        if openpype_versions:  # shouldnt be if exe ???
