"""Alkemy-x module override
Remove credential dialog as it's confusing and we don't need to authenticate for OP's
needs to publish to Shotgrid, we can use $USER instead.
"""
# import os
import webbrowser
