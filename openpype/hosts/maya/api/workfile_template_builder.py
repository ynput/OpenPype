...
class MayaPlaceholderCreatePlugin(PlaceholderPlugin, PlaceholderCreateMixin):
    identifier = "maya.create"
    label = "Maya Create"
    ...
    def _create_placeholder_name(self, placeholder_data):
        ...
        for name_key in ["creator", "create"]:
            if name_key in placeholder_data:
                placeholder_name_parts = placeholder_data[name_key].split(".")
