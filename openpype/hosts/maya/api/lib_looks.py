...
def assign_look_by_version(nodes, version_id, project_name=None):
    ...
    shader_nodes, container_node = load_look(version_id, project_name)
    relationships = get_look_relationships(version_id, project_name)

    # Assign relationships with the loaded shader nodes
...
def get_look_relationships(version_id, project_name=None):
    # type: (str, str) -> dict
    """Get relations for the look.

    Args:
        version_id (str): Parent version Id.
        project_name (Optional[str]): Project name for the version id.
...
def load_look(version_id, project_name=None):
    # type: (str, str) -> tuple
