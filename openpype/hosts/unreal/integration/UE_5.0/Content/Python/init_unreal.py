...
class OpenPypeIntegration(unreal.OpenPypePythonBridge):
    """OpenPype integration for Unreal Engine 5.0."""
    ...
    @unreal.ufunction(override=True)
    def containerise(self, name, namespc, str_nodes, str_context, loader="", suffix="_CON"):
    ...
    @unreal.ufunction(override=True)
    def instantiate(self, root, name, str_data, str_assets="", suffix="_INS"):
