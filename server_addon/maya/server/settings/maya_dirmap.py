...
class MayaDirmapModel(BaseSettingsModel):
    ...
    # Use ${} placeholder instead of absolute value of a root in referenced filepaths.
    use_env_var_as_root: bool = Field(title="Use env var placeholder in referenced paths")
    paths: MayaDirmapPathsSubmodel = Field(default_factory=MayaDirmapPathsSubmodel, title="Dirmap Paths")
