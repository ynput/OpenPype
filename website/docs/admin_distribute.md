...
to its name in `<Project_Root>/openpype/version.py`.

So if you have OpenPype version like `3.0.0` just name it `3.0.0+staging`, thus generating the zip file named
`OpenPype-v3.0.0+staging.zip`.
